          ...
          if( reponse.length > 0 ){
            for (var i = 0; i < reponse.length; i++) {
              ...
              var item              = reponse[i],
                  ...
                  sold_out	       = item.available          ? "" : "<span class='item-sold-out'>Agotado</span> ",
            ...
            result_element.html('<p class="col-12">No se encontraron resultados para su búsqueda.</p>');
             $('.js_productSearchResults').show();
          }
       }     
    });
    ...
    jQuery( document ).delegate( search_input_id ,'keyup',function( event ){
      ...
      ajax_timeout = setTimeout(function() {
        if( keyword.length >= 2 ){
            ...
            result_element.html('<p class="col-12">Debe ingresar al menos 2 caracteres.</p>');
        } 
      },300);       
    }); 
